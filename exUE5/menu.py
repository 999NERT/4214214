...
def _run_export():
    ...
    try:
        ...
        unreal.log(f"[exUE5] âœ“ Export completed!")
        unreal.log(f"[exUE5] File: {output_path}")
    except Exception as exc:
        unreal.log(f"[exUE5] âœ— Export failed: {exc}")
...
def install_menu():
    ...
    try:
        ...
        unreal.log(f"[exUE5]    âœ“ Got ToolMenus")
        ...
        unreal.log("[exUE5]    âœ“ Got main menu bar")
        ...
        unreal.log("[exUE5]    âœ“ Submenu created successfully")
        ...
        unreal.log("[exUE5]    âœ“ Entry added to submenu")
        
        unreal.log("[exUE5] 6. Refreshing menu widgets...")
        menus.refresh_all_widgets()
        unreal.log("[exUE5]    âœ“ Widgets refreshed")
        
        unreal.log("[exUE5] ========== INSTALL MENU SUCCESS ==========")
        unreal.log("[exUE5] âœ“ Menu installed - 'Exporter' should appear on menu bar!")
